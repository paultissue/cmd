...
| Command | Aliases | Response | Stream | Chat | Support |
| --- | --- | --- | --- |--- | --- |
| `ao` | `angry` | 📢 The Angry Oregonian 🇺🇸 | 📺 `@TheAngryOregonian1776` | 💬 `@TheAngryOregonian1776` | CashApp / Venmo |
...
| `ht` | `hoot`, `hoot_troop` | 📢 Hoot Troop 🇺🇸 | 📺 `@Hoot_Troop` | 💬 `@Hoot_Troop` | CashApp / Linktr.ee |
